...
//prototype for Tire class
//-----------------------------
class Tire : public Thing
{
public:
    static bool drop;    //static bool function to make variable unchangable
    Tire(Thing* ptr = 0); //consturctor
    bool isDroped() const; //drop function
    void dropIt(); //what happens after tire droped
};
//-----------------------------
