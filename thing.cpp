...
//------------------------------------------------------
Tire::Tire(Thing* ptr)
    : Thing("tire", "a tire", 3, ptr)
{
}

bool Tire::drop = false; //static variable set

bool Tire::isDroped() const // returen drop
{
    return drop;
}

void Tire::dropIt() //when drop = true output discription
{
    drop = true;
    cout << "\nA tire droped on the ground." << endl;
}
//------------------------------------------------------
